...
1. Портал «Если быть точным» — данные и аналитика о социальных
проблемах.
2. Росстат — государственное статистическое ведомство.
3. Портал статистических данных РФ.
данные в основном содержат информацию за 2017-2024 годы

используемые таблицы сохранены в папку data
в ее подпапке распологаются исходные таблицы
в корень проекта для ознакомления размещен датасет, формирующийся при обьединении таблиц
